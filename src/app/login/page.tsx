...
export default function Login() {
  ...
  return (
    <div className="flex flex-wrap lg:flex-nowrap">
      ...
      ></div>
      <div className="bg-transparent lg:old-bg-black/5 old-dark:bg-white/5 bg-secondary w-full relative lg:w-1/2 h-screen flex flex-col justify-center items-center">
        <div>
